...
<div class="tab-content clearfix" style="border:#ccc 1px solid; border-top:none; padding:10px;">
    ...
    <div class="col-lg-6">
        {!!Form::select('category_id[]', array('1'=>'Cash'), isset($request->category_id)?$user->category_id:null, ["class"=>"form-control", "id"=>"multiple-checkboxes111", 'multiple'=>'multiple','style'=>'width:100px;','onclick'=>'selectCate(this.value)'])!!}
 </div>        
</div>
<div class="form-group row">
