                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if ($material_details == 0) {
                                            ?>
                                            <a href="{{route('requests.show', [$request->id,'call_for_tender_list'])}}" class="btn btn-primary m-b-10 m-l-5"><i class="fa fa-search" aria-hidden="true"></i> View</a>
                                        <?php } else { ?>
                                            <a href="{{route('requests.show', [$request->id,'call_for_tender_list'])}}" class="btn btn-success m-b-10 m-l-5"><i class="fa fa-rupee" aria-hidden="true"></i> Call for tender</a>
                                        <?php } ?>
                                        @else
                                        <a href="{{route('requests.show', [$request->id,'call_for_tender_list'])}}" class="btn btn-success m-b-10 m-l-5"><i class="fa fa-rupee"></i> Call for tender</a>
                                        @endif 
