                                   ...
                                   <div class="form-group row">
                                     ...
                                     <div class="col-lg-6" style="padding:0px;">
                                             ...
                                             <input  type="hidden"  name="user_id" value="{{$requests->user_id}}">
                                              ...
                                              <button class="btn btn-primary submit" type="submit" name="approve"  value="Approve"  onclick="return loadAddApprove()" style="margin-right:40px;"><i class="fa fa-check-circle"></i> Approve</button>
