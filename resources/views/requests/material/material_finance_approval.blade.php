...
<br>                                   <div class="col-lg-6">
                                             ...
                                             <button class="btn btn-primary submit" type="submit" name="finance"  value="finance" onclick="return loadAddApprove()" style="margin-right:40px;"><i class="fa fa-check-circle"></i> Approve</button>
