<div class="form-group row">
    ...
    <div class="col-lg-6">
        {!!Form::select('category_id[]', $categories, isset($request->category_id)?$user->category_id:null, ["class"=>"form-control", "id"=>"multiple-checkboxes", 'multiple'=>'multiple','style'=>'width:100px;','onclick'=>'selectCate(this.value)'])!!}
 </div>        
</div>
<div class="form-group row">
...
<script>
   ...
   {
       multiple_checkboxes = $('#multiple-checkboxes').val();
