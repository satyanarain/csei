        ...
        <div class="card">
            <div class="card-body">
                <div class="form-validation">
                    ...
                    <td width="45%" align="left" valign="top"> 
                        <table  class="table table-bordered  table-striped table-hover bank_table">
                            ...
                            <tr  class="table-row" style="text-align:left; ">
                                <td width="30%" align="left" style="text-align:left;" valign="top"> P. C. S | No.</td>
                                <td style="text-align:left;" align="left" valign="top">
                                    {{$total}}
                                    {!! Form::hidden('po_number', $total, ['style'=>"height:32px;"]) !!}
                                </td>
                            </tr> 
                            <tr>
                    ...
                    <table width="100%" align="left" style="text-align:left;" border="1" class="table table-bordered  table-striped table-hover bank_table">
                        <tr  style="text-align:left; padding-bottom:20px;"> 
                            <td align="left" valign="top" style="text-align:left" colspan="3"><b>To</b></td>
                           
                        </tr>
                        
                        <tr  style="text-align:left; padding-bottom:20px;"> <td align="left" valign="top" style="text-align:left">Name</td><td align="left" valign="top" style="text-align:left">:</td><td align="left" valign="top" style="text-align:left">{{$vendor_quotation_lists->name}}</td></tr>
                        ...
                        <tr> <td align="left" valign="top" style="text-align:left">Address</td><td align="left" valign="top" style="text-align:left">:</td>
                            <td align="left" valign="top" style="text-align:left">
                                <table width="100%" style="padding:0px; margin:0px; border:none;">
                                <tr style="padding:0px; margin:0px; border:none;">
                                    <td align="left" valign="top" style="text-align:justify;padding:0px; margin:0px; border:none; background-color:#fff;" width="40%">{{$vendor_quotation_lists->address}}</td>
                                    <td align="left" valign="top" style="text-align:left;padding:0px; margin:0px; border:none;background-color:#fff;"></td>
                                </tr>
                                    </table>
