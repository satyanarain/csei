                 ...
                 <?php if($count123==0)
                      {
                         ?>
                  <td>
                     <a href="{{route('call_for_tender.show',[$vendor_quotation_lists->id])}}" class="btn btn-primary m-b-10 m-l-5"><i class="fa fa-paper-plane"></i> Send To Review</a>
                        </td>
                    <?php  } else { ?>
                         <td>

                                            <a href="{{route('call_for_tender.show',[$vendor_quotation_lists->id,'view'])}}" class="btn btn-primary m-b-10 m-l-5"><i class="fa fa-search"></i></i> View</a>
                         </td>
 <?php } ?>
