...
<!--================================================================================
  ...
  <head>
    ...
    <title>Indusbus | {{ucfirst($active)}}</title>
      ...
      <div class="navbar-fixed">
        <nav class="navbar-color">
          <div class="nav-wrapper">
            <ul class="left">                      
              <li><h1 class="logo-wrapper"><a href="{{route('/')}}" class="brand-logo darken-1"><img src="{{URL::to('logo/indusBusLogo270.png')}}" alt="materialize logo"></a> <span class="logo-text">Indusbus</span></h1></li>
            </ul>
            <div class="header-search-wrapper hide-on-med-and-down">
              <i class="mdi-action-search"></i>
              <input type="text" name="Search" class="header-search-input z-depth-2" placeholder="Explore Indusbus"/>
            </div>
  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
          ...
          <li class="user-details cyan darken-2">
            <div class="row">
              <div class="col col s4 m4 l4">
                <img src="{{isset(Auth::user()->profile_picture) ? URL::to('images/userProfiles/'.Auth::user()->profile_picture) : URL::to('images/default-avatar.jpg')}}" alt="" class="circle responsive-img valign profile-image profile-image">
              </div>
        ...
        <li class="bold {{$active == 'home' ? 'active' : ''}}"><a href="{{route('home')}}" class="waves-effect waves-cyan"><i class="mdi-action-dashboard"></i> Dashboard</a>
        </li>
        @if(Entrust::hasRole('administrator') || Entrust::hasRole('state-administrator'))
        <li class="no-padding">
          <ul class="collapsible collapsible-accordion">
            <li class="bold"><a class="collapsible-header waves-effect waves-cyan  {{$active == 'users' ? 'active' : ''}}"><i class="mdi-action-account-circle"></i> Users</a>
              <div class="collapsible-body">
                <ul>
                  <li class="{{($active2 == '' && $active == 'users') ? 'active' : ''}}"><a href="{{route('users.index')}}">All Users</a>
                  </li>
                  <li class="{{($active2 == 'create' && $active == 'users') ? 'active' : ''}}"><a href="{{route('users.create')}}">New User</a>
                  </li>
                  </ul
                </div>
              </li>
          ...
          <li class="no-padding">
            <ul class="collapsible collapsible-accordion">
              <li class="bold"><a class="collapsible-header waves-effect waves-cyan  {{$active == 'roles' ? 'active' : ''}}"><i class="mdi-action-info"></i> Roles</a>
                <div class="collapsible-body">
                  <ul>
                    <li class="{{($active2 == '' && $active == 'roles') ? 'active' : ''}}"><a href="{{route('roles.index')}}">All Roles</a>
                    </li>
                    <li class="{{($active2 == 'create' && $active == 'roles') ? 'active' : ''}}"><a href="{{route('roles.create')}}">New Role</a>
                    </li>
                  </ul>
                </div>
              </li>
          ...
          <li class="no-padding">
            <ul class="collapsible collapsible-accordion">
              <li class="bold"><a class="collapsible-header waves-effect waves-cyan  {{$active == 'permissions' ? 'active' : ''}}"><i class="mdi-action-lock"></i> Permissions</a>
                <div class="collapsible-body">
                  <ul>
                    <li class="{{($active2 == '' && $active == 'permissions') ? 'active' : ''}}"><a href="{{route('permissions.index')}}">All Permissions</a>
                    </li>
                    <li class="{{($active2 == 'create' && $active == 'permissions') ? 'active' : ''}}"><a href="{{route('permissions.create')}}">New Permission</a>
                    </li>
                  </ul>
                </div>
              </li>
        ...
        <!-- <div class="container">
          ...
          <div class="footer-copyright">
            <div class="container">
              Copyright © 2018 <a class="grey-text text-lighten-4" href="http://opiant.in" target="_blank">Indusbus</a> All rights reserved.
              <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="http://opiant.in">Opiant</a></span>
            </div>
          </div>
        </footer>
        <!-- END FOOTER -->
